"""
LOGISTIC REGRESSION - Model experimental pentru comparație
Antrenarea modelului MULTICLASS pentru 3 rezultate posibile

Input: dataset_training.csv (din folderul model original)
Output: logistic_regression_3class.pkl, scaler_logistic.pkl, feature_cols.pkl
...
print("=" * 100)
print("🎯 MODEL MULTICLASS - LOGISTIC REGRESSION (3 REZULTATE POSIBILE)")
print("=" * 100)
...
# === ANTRENARE LOGISTIC REGRESSION MULTICLASS ===
print(f"\n🚀 Antrenare Logistic Regression Classifier (Multiclass)...")
print(f"   max_iter: 1000")
print(f"   solver: lbfgs (multinomial)")
print(f"   C (regularization): 1.0")
print(f"\n⏳ Durata estimată: 2-5 minute...")
...
# === COEFICIENȚI (pentru Logistic Regression) ===
print(f"\n🔍 Top 10 Features Importante (absolute coeficienți):")
abs_coefs = np.abs(model.coef_).mean(axis=0)  # Mean across classes
...
joblib.dump(model, "logistic_regression_3class.pkl")
...
print(f"\n✓ Fișiere salvate:")
print(f"   - logistic_regression_3class.pkl")
print(f"   - scaler_logistic.pkl")
print(f"   - feature_cols.pkl")
print(f"   - test_matches.pkl")

print(f"\n" + "=" * 100)
print("✅ ANTRENARE LOGISTIC REGRESSION COMPLETĂ!")
print("=" * 100)
print(f"\nModelul Logistic Regression pentru comparație experimentală")
print(f"   Model liniar coeficienți interpretabili")
print(f"   Viteză: FOARTE RAPIDĂ (secunde)")
print(f"   Performanță: de obicei mai slabă decât Gradient Boosting pe datos complexe")
